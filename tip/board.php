...
<?php
    ...
    $sql = "SELECT b.boardID, b.boardTitle, m.youName, b.regTime, b.boardView FROM PmyBoard b JOIN TPmyMember m ON(m.memberID = b.memberID) ORDER BY boardID DESC LIMIT {$pageLimit}, {$pageView}";
