...
<?php
    ...
    $sql = "SELECT b.boardTitle, m.youName, b.regTime, b.boardView, b.boardContents FROM PmyBoard b JOIN TPmyMember m ON(m.memberID = b.memberID) WHERE b.boardID = {$boardID}";
    $result = $connect -> query($sql);

    $sql = "UPDATE PmyBoard SET boardView = boardView + 1 WHERE boardID = {$boardID}"; //조회수 올라가기
    $connect -> query($sql);
