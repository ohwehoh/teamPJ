...
<body>    
    ...
    <main id="contents">
        ...
        <section id="board-type" class="section center mb100">
            <div class="container">
                <h3 class="section__title">고민 게시판</h3>
...
<?php
    ...
    $sql = "SELECT b.boardID, b.boardTitle, m.youName, b.regTime, b.boardView FROM PmyBoard02 b JOIN TPmyMember m ON(m.memberID = b.memberID) ORDER BY boardID DESC LIMIT {$pageLimit}, {$pageView}";
